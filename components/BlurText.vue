<template>
  <component :is="tag" ref="rootRef" class="flex flex-wrap blur-text" :class="className">
    <Motion
...
type BlurTextTag = 'p' | 'span' | 'div' | 'h1' | 'h2' | 'h3' | 'h4' | 'section' | 'label';

const props = withDefaults(defineProps<BlurTextProps & { tag?: BlurTextTag }>(), {
  text: '',
  delay: 200,
  className: '',
  animateBy: 'words',

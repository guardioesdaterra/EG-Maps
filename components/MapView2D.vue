 ...
 */
<template>
  <div tabindex="-1" class="w-full h-[100svh] relative overflow-hidden bg-black focus:outline-none" role="main" aria-label="Interactive Map Visualization">
...
const MAPTILER_KEY = useRuntimeConfig().public.maptilerApiKey || ''

useHead({
  // Tiles dominate first paint (multi-second); hint the connection early.
  link: props.defaultDataset === 'endangered-species' || MAPTILER_KEY

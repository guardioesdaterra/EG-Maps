...
export default defineNuxtConfig({
  ...
  nitro: {
    ...
    prerender: {
      crawlLinks: true,
      routes: ['/', '/globe', '/info', '/project-grants', '/project-grants/3d', '/endangered-species', '/endangered-species/3d', '/active-crews', '/active-crews/3d', '/vulcan-observatory', '/vulcan-observatory/3d', '/eg-grants', '/eg-grants/fullscreen', '/iframe', '/iframe/squarespace', '/campaigns', '/crew-projects', '/masterclasses'],

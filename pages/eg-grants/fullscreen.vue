...
<template>
  <div id="main-content" tabindex="-1" class="fs-grants min-h-screen bg-black text-white" :class="{ 'is-embedded': isEmbedded }">
    <div v-if="isPostbackTab" class="eg-gate fixed inset-0 flex items-center justify-center bg-black" style="z-index: 99999">
    ...
    <div v-else-if="!sessionReady" class="eg-gate fixed inset-0 flex items-center justify-center bg-black" style="z-index: 99999">
...
const { t } = useI18n()
const { user, isManager, managerCheckError, retryManagerCheck, signIn, signInWithNewAccount, switchAccount, signOut, sessionReady, autoSignInIfRequested, isPostbackTab, postbackDone } = useSupabaseAuth()

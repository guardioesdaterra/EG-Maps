    ...
    <section class="w-container-narrow max-h-[calc(100svh-9rem)] overflow-hidden rounded-fluid-lg border-2 border-[var(--border-color)] bg-[var(--bg-tertiary)] text-[var(--text-primary)] shadow-[0_0_0_1px_var(--border-color)]">
      ...
      <div class="grid grid-cols-2 border-b-2 border-[var(--border-color)] sm:grid-cols-4">
        <button
          ...
          :key="tab.id"
          type="button"
          class="flex min-w-0 items-center justify-center gap-1.5 xs:gap-2 border-b border-r border-[var(--border-color)] px-2 xs:px-3 py-2.5 xs:py-3 text-[clamp(11px,1.6vw,14px)] xs:text-sm font-black transition-colors even:border-r-0 sm:border-b-0 sm:border-r sm:last:border-r-0"

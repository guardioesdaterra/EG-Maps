 ...
 * @why Vulcan observatory 3D globe — observatory data on globe with timeline
 *      slider and cultural-agent overlay (Mapa Cultura BR + Floresta Ativista
 *      + community pins).
 *
 * Data flow: identical to pages/vulcan-observatory/index.vue. See that
 * page's header comment for the full data-source breakdown.
 *
 * @deps @/composables/useI18n (useI18n);
 *       @/composables/useVulcanObservatoryPage (useVulcanObservatoryPage)
 * @connections /vulcan-observatory/index.vue (2D counterpart sharing the
 *             same data composable)
 */
<template>
